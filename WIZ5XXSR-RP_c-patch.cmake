...
set(WIZ5XXSR-RP_C_SRC_DIR "${CMAKE_CURRENT_SOURCE_DIR}")
set(IOLIBRARY_DRIVER_SRC_DIR "${WIZ5XXSR-RP_C_SRC_DIR}/libraries/ioLibrary_Driver")
set(MBEDTLS_SRC_DIR "${WIZ5XXSR-RP_C_SRC_DIR}/libraries/mbedtls")
set(PICO_EXTRAS_SRC_DIR "${WIZ5XXSR-RP_C_SRC_DIR}/libraries/pico-extras")
set(PICO_SDK_SRC_DIR "${WIZ5XXSR-RP_C_SRC_DIR}/libraries/pico-sdk")
set(PICO_SDK_TINYUSB_SRC_DIR "${WIZ5XXSR-RP_C_SRC_DIR}/libraries/lib/tinyusb")
set(WIZ5XXSR-RP_C_PATCH_DIR "${WIZ5XXSR-RP_C_SRC_DIR}/patches")
...
execute_process(COMMAND ${GIT_EXECUTABLE} -C ${WIZ5XXSR-RP_C_SRC_DIR} submodule update --init)
...
file(GLOB IOLIBRARY_DRIVER_PATCHES 
	"${WIZ5XXSR-RP_C_PATCH_DIR}/01_iolibrary_driver_ethernet_chip.patch" 
	"${WIZ5XXSR-RP_C_PATCH_DIR}/02_iolibrary_driver_ftp_client.patch"
	)
