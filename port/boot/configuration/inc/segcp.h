...
typedef enum {SEGCP_MC, SEGCP_VR, SEGCP_MN, SEGCP_IM, SEGCP_OP, SEGCP_CP, SEGCP_DG, SEGCP_KA, SEGCP_KI, SEGCP_KE,
              ...
              SEGCP_EC, SEGCP_GA, SEGCP_GB, SEGCP_GC, SEGCP_GD, SEGCP_CA, SEGCP_CB, SEGCP_CC, SEGCP_CD, SEGCP_RX,
              SEGCP_UI, SEGCP_TR, SEGCP_QU, SEGCP_QP, SEGCP_QC, SEGCP_QK, SEGCP_PU, SEGCP_U0, SEGCP_U1, SEGCP_U2,
              SEGCP_QO, SEGCP_RC, SEGCP_CE, SEGCP_OC, SEGCP_LC, SEGCP_PK, SEGCP_UF, SEGCP_FW, SEGCP_SO, SEGCP_UNKNOWN=255
} teSEGCPCMDNUM;
